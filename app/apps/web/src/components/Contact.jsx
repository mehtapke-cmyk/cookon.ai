          ...
          >
            <div>
              <input
                ...
                className="w-full px-6 py-4 bg-white border border-gray-200 focus:border-gray-900 focus:outline-none transition-colors text-gray-900"
                required
                disabled={loading}
              />
            </div>
            ...
            <div>
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-6 py-4 bg-white border border-gray-200 focus:border-gray-900 focus:outline-none transition-colors resize-none text-gray-900"
                required
                disabled={loading}
              />
            </div>
